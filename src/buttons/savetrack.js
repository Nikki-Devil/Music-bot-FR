...
module.exports = async ({ inter, queue }) => {
    ...
    inter.member.send({
        embeds: [
            new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Sonate par:', value: `\`${queue.currentTrack.author}\``, inline: true },
        ...
        return inter.editReply({ content: `Je vous ai envoyé le titre de la sonate en privée ✅`, ephemeral: true });
    }).catch(error => {
